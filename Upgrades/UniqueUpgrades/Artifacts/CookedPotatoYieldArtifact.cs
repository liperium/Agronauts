...
public partial class CookedPotatoYieldArtifact : ArtifactUpgrade<MultiplierModifier>
{
	...
	{
		base.InitInfo();
		info.SetName("KCOOKEDYIELDARTIFACT");
		info.SetDescription("KCOOKEDYIELDARTIFACTDESC");
